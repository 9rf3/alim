...
export default function CabinetOverview() {
    ...
    const featureCards = [
        ...
        { icon: 'atom', color: 'orange', title: t('Симуляции', 'Simulations'), description: t('Интерактивные 3D модели по физике, химии и математике', 'Interactive 3D models for physics, chemistry, and math'), path: '/cabinet/simulations', stat: t('Скоро', 'Coming Soon') },
        ...
        { icon: 'chart', color: 'purple', title: t('Мои данные', 'My Data'), description: t('Статистика, прогресс и аналитика обучения', 'Statistics, progress, and learning analytics'), path: '/cabinet/data',             stat: '—' },
        { icon: 'shopping', color: 'green', title: t('Торговля', 'Trading'), description: t('Покупайте и продавайте проекты и материалы', 'Buy and sell projects and materials'), path: '/cabinet/marketplace',             stat: '0' },
    ];
            ...
            <div className="cabinet-header">
                <div className="cabinet-header-top">
                    ...
                    <div className="cabinet-header-actions">
                        <Link to="/cabinet/profile" className="cabinet-btn secondary">
